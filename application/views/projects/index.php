<div class="span12">
	...
	<div class="about-info span11">
		...
		<div class="project-info span11">
			...
			<div class="project-images span11" id="techtuit-project-images">
				<ul>
		...
		<div class="project-info span11">
			...
			<div class="project-images span11" id="rajahtours-project-images">
				<ul>
		...
		<div class="project-info span11">
			...
			<div class="project-images span11" id="daito-project-images">
				<ul>
		...
		<div class="project-info span11">
			...
			<div class="project-images span11" id="manken-project-images">
				<ul>
